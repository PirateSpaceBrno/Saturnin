...
namespace Saturnin.Helpers
{
    public class WebHelper
    {
        ...
        private static string GetContent(Stream contentStream, Encoding encoding)
        {
        ...
        /// <returns></returns>
        private static string GetCharsetFromBody(Stream contentStream)
        {
            contentStream.Seek(0, SeekOrigin.Begin);
        ...
        /// <returns></returns>
        private static Encoding GetEncodingOrDefaultToUTF8(string charset)
        {
